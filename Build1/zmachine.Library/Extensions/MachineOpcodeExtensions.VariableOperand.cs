namespace zmachine.Library.Extensions
{
    ...
    public static partial class MachineOpcodeExtensions
    {
        ...
        public static void op_storew(this Machine machine, List<ushort> operands) => machine.Memory.setWord((uint)(operands[0] + 2 * operands[1]), operands[2]);
        
        public static void op_storeb(this Machine machine, List<ushort> operands) => machine.Memory.setByte((uint)(operands[0] + operands[1]), (byte)operands[2]);
        
        public static void op_put_prop(this Machine machine, List<ushort> operands) => machine.ObjectTable.setObjectProperty(operands[0], operands[1], operands[2]);
        
        public static void op_sread(this Machine machine, List<ushort> operands) => machine.ReadLex(operands);
        
        public static void op_print_char(this Machine machine, List<ushort> operands) => machine.IO.Write("" + machine.Memory.getZChar(operands[0]));
        
        public static void op_print_num(this Machine machine, List<ushort> operands) => machine.IO.Write(Convert.ToString(value: (short)operands[0], toBase: 10));
        ...
        public static void op_pushun(this Machine machine, List<ushort> operands) => machine.setVar(0, operands[0]);
        
        public static void op_pull(this Machine machine, List<ushort> operands) => machine.setVar(operands[0], machine.getVar(0));
        
        public static void op_split_window(this Machine machine, List<ushort> operands) => fail_unimplemented(machine);
        
        public static void op_set_window(this Machine machine, List<ushort> operands) => fail_unimplemented(machine);
        ...
        public static void op_input_stream(this Machine machine, List<ushort> operands) => fail_unimplemented(machine);
