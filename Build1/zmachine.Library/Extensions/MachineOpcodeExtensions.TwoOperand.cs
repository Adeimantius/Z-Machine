    ...
    public static TwoOperandOpcode process2OP(this Machine machine, int opcode, List<ushort> operands)
    {
        ...
        switch (twoOperandOpcode)
        {
            case TwoOperandOpcode.op_add:
                op_add(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_and:
                op_and(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_clear_attr:
                op_clear_attr(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_dec_chk:
                op_dec_chk(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_div:
                op_div(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_get_next_addr:
                op_get_next_addr(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_get_prop:
                op_get_prop(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_get_prop_addr:
                op_get_prop_addr(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_inc_chk:
                op_inc_chk(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_insert_obj:
                op_insert_obj(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_je:
                op_je(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_jg:
                op_jg(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_jin:
                op_jin(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_jl:
                op_jl(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_loadb:
                op_loadb(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_loadw:
                op_loadw(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_mod:
                op_mod(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_mul:
                op_mul(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_or:
                op_or(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_set_attr:
                op_set_attr(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_store:
                op_store(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_sub:
                op_sub(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_test:
                op_test(machine, operands[0], operands[1]);
                break;
            case TwoOperandOpcode.op_test_attr:
                op_test_attr(machine, operands[0], operands[1]);
                break;
            default:
