...
public static partial class MachineOpcodeExtensions
{
    ...
    public static void op_nop(this Machine machine)
    {
    }
    ...
    {
        if (!Enum.IsDefined(typeof(NoOperandOpcode), opcode))
        {
