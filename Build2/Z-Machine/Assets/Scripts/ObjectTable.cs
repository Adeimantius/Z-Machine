...
namespace zmachine
{
    class ObjectTable
    {
        ...
        public int getObjectProperty(int objectId, int property)
        {
            ...
            {
                propertyData = 0;
                Debug.Log("Property Length " + propLen + " is an unspecified length call for opcodes.");
            }
...
//            Debug.Log("BEFORE address: " + address + " " + memory.getByte(address) + "," + memory.getByte(address + 1) + "," + memory.getByte(address + 2) + "," + memory.getByte(address + 3));
...
//            Debug.Log("AFTER address: " + address + " " + memory.getByte(address) + "," + memory.getByte(address + 1) + "," + memory.getByte(address + 2) + "," + memory.getByte(address + 3));
